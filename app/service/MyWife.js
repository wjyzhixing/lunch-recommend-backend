...
class Test extends egg_1.Service {
    ...
    async addMyWifeFood(values) {
        ...
        try {
            ...
            if ((findResults === null || findResults === void 0 ? void 0 : findResults.length) === 0) {
                const results = await ctx.model.Food.create({
                    food: values === null || values === void 0 ? void 0 : values.food,
                    times: Number(values === null || values === void 0 ? void 0 : values.times) || 0,
                    love: Number(values === null || values === void 0 ? void 0 : values.love) || 5,
                    user: String(values === null || values === void 0 ? void 0 : values.user)
                    // Article为modal/article.js里面命名的名字
                    // id: 2,
                    // _id: app.mongoose.Types.ObjectId('6231b28691e2bcb857babb56'),
                });
    ...
    async updateMyWifeFood(values) {
        const { ctx, app } = this;
        try {
            const results = await ctx.model.Food.updateOne({ _id: app.mongoose.Types.ObjectId(values === null || values === void 0 ? void 0 : values.id) }, {
                food: values === null || values === void 0 ? void 0 : values.food,
    ...
    async recommendMyWifeFood(params) {
        ...
        try {
            ...
            const res = results === null || results === void 0 ? void 0 : results.map(item => {
                return {
                    food: item === null || item === void 0 ? void 0 : item.food,
                    value: utils_1.computedValue(item === null || item === void 0 ? void 0 : item.times, item === null || item === void 0 ? void 0 : item.love),
                };
            }).sort((a, b) => b.value - a.value);
            const resTrue = res === null || res === void 0 ? void 0 : res.filter(item => { var _a; return item.value === ((_a = res[0]) === null || _a === void 0 ? void 0 : _a.value); });
            console.log(resTrue);
            return ctx.helper.json(resTrue.map(i => i.food)[utils_1.rand(0, resTrue === null || resTrue === void 0 ? void 0 : resTrue.length)]);
        }
        catch (err) {
            ctx.body = ctx.helper.json(JSON.stringify(err));
        }
    ...
    async updateRandomFoodList(values) {
        ...
        try {
            ...
            if ((resValue === null || resValue === void 0 ? void 0 : resValue.length) === 0) {
                ...
                const results = await ctx.model.RandomType.updateOne({ type: 'food', user: values === null || values === void 0 ? void 0 : values.user }, {
                    value: values === null || values === void 0 ? void 0 : values.food,
                });
                return ctx.helper.json(results);
            }
